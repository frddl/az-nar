            ...
            <div class="basket_cards">
                <div class="basket_card">
                    ...
                    <div class="basket_card_right">
                        <h4 class="b_productname">{{$share->name}}</h4>
                        <p class="basket_product_desc">{!! $share->text !!}</p>
                            ...
                            <div class="basket_bottom_buttons">
                                <div>
                                    ...
                                    <div class="basket_pro_price">
                                        <span class="bpp_val" id="product_price">{{$share->price}}</span>
                                        <span class="azn"></span>
                                    </div>
                                </div>
                                <div>
