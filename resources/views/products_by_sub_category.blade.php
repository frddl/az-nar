        ...
        <div class="products_container">
            ...
            <div class="products_container_right">
                ...
                <div class="pro_right_tablinks">
                    <a href="{{route('product.allByCat', $data->id)}}" class="{{(request()->segment(4)==null) ? "active" : ""}}">@lang('ВСЕ')</a>
                    @foreach($data->subCategories as $sub)
                        <a href="{{route('product.allBySubCat', [$data->id, $sub->id])}}" class="{{(request()->segment(4) == $sub->id) ? "active" : ""}}">{{$sub->name}}</a>
                    @endforeach
                </div>
